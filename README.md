            ...
            "outputs": [
                {
                    "name": "stdout",
                    "output_type": "stream",
                    "text": "Validaton Data Accuracy:\t0.6666666667\n"
                }
            ],
            "source": "from sklearn.metrics import accuracy_score\nfrom sklearn.neighbors import KNeighborsClassifier\n\nk = 5\nneigh = KNeighborsClassifier(n_neighbors = k).fit(X_train,y_train)\nyhat = neigh.predict(X_val)\n\nprint(\"Validaton Data Accuracy:\\t%.10f\" %accuracy_score(y_val, yhat))"
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            ...
            "outputs": [
                {
                    "name": "stdout",
                    "output_type": "stream",
                    "text": "KNN Accuracy with k=1:\t0.3333333333\nKNN Accuracy with k=2:\t0.3333333333\nKNN Accuracy with k=3:\t0.5000000000\nKNN Accuracy with k=4:\t0.5833333333\nKNN Accuracy with k=5:\t0.6666666667\nKNN Accuracy with k=6:\t0.5833333333\nKNN Accuracy with k=7:\t0.5833333333\nKNN Accuracy with k=8:\t0.6666666667\nKNN Accuracy with k=9:\t0.5833333333\nKNN Accuracy with k=10:\t0.5833333333\nKNN Accuracy with k=11:\t0.5833333333\nKNN Accuracy with k=12:\t0.5000000000\nKNN Accuracy with k=13:\t0.5833333333\nKNN Accuracy with k=14:\t0.5833333333\nKNN Accuracy with k=15:\t0.5833333333\n"
                }
            ],
            "source": "for k in range(1,16):\n    neigh = KNeighborsClassifier(n_neighbors = k).fit(X_train,y_train)\n    yhat = neigh.predict(X_val)\n\n    print(\"KNN Accuracy with k=%i:\\t%.10f\" %(k, accuracy_score(y_val, yhat)))"
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            ...
            "outputs": [
                {
                    "name": "stdout",
                    "output_type": "stream",
                    "text": "SVM Accuracy with kernel=linear:   \t0.2500000000\nSVM Accuracy with kernel=poly:   \t0.6666666667\nSVM Accuracy with kernel=rbf:   \t0.5833333333\nSVM Accuracy with kernel=sigmoid:   \t0.5000000000\n"
                }
            ],
            "source": "kernels = ['linear', 'poly', 'rbf', 'sigmoid']\n\nfor kernel in kernels:\n    clf = svm.SVC(kernel=kernel, gamma='auto').fit(X_train, y_train) \n    yhat = clf.predict(X_val)\n    print(\"SVM Accuracy with kernel=%s:   \\t%.10f\" %(kernel, accuracy_score(y_val, yhat)))"
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            ...
            "outputs": [
                {
                    "name": "stdout",
                    "output_type": "stream",
                    "text": "Logistic Regression Accuracy with C=0.01:\t0.5833333333\n"
                }
            ],
            "source": "LR = LogisticRegression(C=0.01, solver='lbfgs', multi_class='auto').fit(X_train,y_train)\nyhat = LR.predict(X_val)\nprint(\"Logistic Regression Accuracy with C=0.01:\\t%.10f\" %accuracy_score(y_val, yhat))"
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            ...
            "outputs": [
                {
                    "name": "stdout",
                    "output_type": "stream",
                    "text": "Avg F1-score: 0.6285714286\nJaccard score: 0.6285714286\n"
                }
            ],
            "source": "k = 5\nneigh = KNeighborsClassifier(n_neighbors = k).fit(X_train,y_train)\nyhat = neigh.predict(test_X)\n\nprint(\"Avg F1-score: %.10f\" % f1_score(test_y, yhat, average='micro'))\nprint(\"Jaccard score: %.10f\" % jaccard_similarity_score(test_y, yhat))"
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            ...
            "outputs": [
                {
                    "name": "stdout",
                    "output_type": "stream",
                    "text": "Avg F1-score: 0.6428571429\nJaccard score: 0.6428571429\n"
                }
            ],
            ...
            "outputs": [
                {
                    "name": "stdout",
                    "output_type": "stream",
                    "text": "Avg F1-score: 0.6857142857\nJaccard score: 0.6857142857\n"
                }
            ],
            "source": "clf = svm.SVC(kernel='poly', gamma='auto').fit(X_train, y_train) \nyhat = clf.predict(test_X)\n\nprint(\"Avg F1-score: %.10f\" % f1_score(test_y, yhat, average='micro'))\nprint(\"Jaccard score: %.10f\" % jaccard_similarity_score(test_y, yhat))"
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            ...
            "outputs": [
                {
                    "name": "stdout",
                    "output_type": "stream",
                    "text": "Avg F1-score: 0.5714285714\nJaccard score: 0.5714285714\n"
                }
            ],
